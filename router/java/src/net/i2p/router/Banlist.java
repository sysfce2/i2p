...
public class Banlist {
    ...
    public final static Integer BANLIST_CODE_TEMPORARY = 0;
    public final static Integer BANLIST_CODE_FOREVER = 1;
    ...
    private boolean banlistRouter(Hash peer, String reason, String reasonComment, String transport, boolean hard) {
        ...
        if (hard) {
            ...
            reasonCode = BANLIST_CODE_FOREVER;
        } else if (transport != null) {
            expireOn = _context.clock().now() + BANLIST_DURATION_PARTIAL;
            reasonCode = BANLIST_CODE_TEMPORARY;
        } else {
    ...
    public boolean banlistRouter(Hash peer, String reason, String reasonComment, String transport, long expireOn) {
        Integer reasonCode = BANLIST_CODE_TEMPORARY;  // Default
        // To maintain legacy behavior, set reasonCode to BANLIST_CODE_FOREVER
     ...
     *         BANLIST_CODE_TEMPORARY - 0
     *         BANLIST_CODE_FOREVER - 1
    ...
    public boolean banlistRouter(Hash peer, String reason, String reasonComment, Integer reasonCode, String transport, long expireOn) {
        ...
        if (old != null) {
            ...
            // Preserve BANLIST_CODE_FOREVER over BANLIST_CODE_TEMPORARY
