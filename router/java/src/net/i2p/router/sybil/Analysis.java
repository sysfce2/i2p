            ...
            for (Map.Entry<String, Long> e : map.entrySet()) {
                ...
                if (s.contains(".") || s.contains(":")) {
                    ...
                    if (b != null && b.length == Hash.HASH_LENGTH) {
                        ...
                        ban.banlistRouter(h, "Sybil analysis", null, ban.BANLIST_CODE_FOREVER, null, until);
                    }
                }
            }
        }
    ...
    private void doBlocking(Map<Hash, Points> points) {
        ...
        for (Map.Entry<Hash, Points> e : points.entrySet()) {
            ...
            if (p >= threshold) {
                ...
                _context.banlist().banlistRouter(h, reason, null, Banlist.BANLIST_CODE_FOREVER, null, blockUntil);
            }
        }
        if (!blocks.isEmpty())
